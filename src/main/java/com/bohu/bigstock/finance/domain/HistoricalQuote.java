...
public class HistoricalQuote {
    ...
    public HistoricalQuote(String symbol, Calendar date, BigDecimal open, BigDecimal low, BigDecimal high, BigDecimal close, BigDecimal adjClose, Long volume, BigDecimal tradeAmount) {
        this.symbol = symbol;
        this.date = date;
        this.open = open;
        this.low = low;
